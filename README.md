...
Backend oficial stats: cuando hay poco histórico en draws, `/api/number-stats` usa estadísticas oficiales de SELAE como fuente principal para calientes y fríos. También añade `/api/official-number-stats` y `POST /api/admin/refresh-official-number-stats`.
