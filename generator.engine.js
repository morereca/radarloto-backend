...
function getGameConfig(game) {
  if (game === 'primitiva') {
    return { mainMin: 1, mainMax: 49, mainCount: 6, split: 24, extraType: 'reintegro', extraMin: 0, extraMax: 9, extraCount: 1 };
  }
  if (game === 'euromillones') {
    return { mainMin: 1, mainMax: 50, mainCount: 5, split: 25, extraType: 'stars', extraMin: 1, extraMax: 12, extraCount: 2 };
  }
...
export function generateNumbers({ game, mode = 'random', stats = {} }) {
  switch (mode) {
