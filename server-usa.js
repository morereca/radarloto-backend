...
app.get("/api/usa/prize-ranking", async (_req, res) => {
  ...
  for (const item of generatedRanking) {
  ...
  res.json({
    ...
    evaluated_combinations: stats.total_generated,
    evaluated_count: stats.total_generated,
    total_evaluated: stats.total_generated,
    total_considered: stats.total_generated,
    winning_combinations: built.length
  });
});
