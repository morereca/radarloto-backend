...
app.get("/api/prize-ranking", async (req, res) => {
  try {
    ...
    res.json({
      ...
      ranking_engine_version: "es-same-day-prizes-v2",
      methodology: "Se muestran combinaciones con premio real en sorteos del mismo día o posteriores a su generación"
    });
  } catch (error) {
